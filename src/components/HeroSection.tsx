    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-5">
        ...
        <img 
          src={frogCharacter} 
          alt="" 
          className="absolute left-[8%] top-[61%] w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 opacity-90 animate-[float_6s_ease-in-out_infinite]"
        />
        ...
        <img 
          src={pyramidIcon} 
          alt="" 
          className="absolute right-[8%] top-[61%] w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 opacity-90 animate-[float_7s_ease-in-out_infinite_1s]"
        />
      </div>
