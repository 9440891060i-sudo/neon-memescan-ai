    ...
    <div className="max-w-7xl mx-auto mb-16">
      <div className="mb-6">
        <div className="flex items-center gap-3 pb-3 border-b border-gray-700">
          <h2 className="text-lg font-medium text-gray-200 uppercase tracking-wider font-mono">Analysis Queue</h2>
          <div className="h-4 w-px bg-gray-600"></div>
          <span className="text-xs text-gray-400 uppercase tracking-wide font-mono">
      ...
      <div className="bg-gray-950 border border-gray-800 rounded-none shadow-none">
        <div className="border-b border-gray-800 bg-gray-900">
          <div className="grid grid-cols-12 gap-4 px-6 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider font-mono">
        ...
        <div>
          {queuedCoins.map((coin, index) => (
            <div
              ...
              className={`grid grid-cols-12 gap-4 px-6 py-4 border-b border-gray-800 cursor-pointer transition-colors duration-150 hover:bg-gray-900/50 font-mono ${
            ...
            >
              ...
              <div className="col-span-4">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-gray-800 border border-gray-700 flex items-center justify-center text-xs text-gray-400">
                    {coin.logo}
                  </div>
              ...
              <div className="col-span-2">
                <div className="flex items-center gap-2">
                  <div className={`w-1.5 h-1.5 rounded-full ${
                    coin.status === 'analyzing' ? 'bg-amber-600' : 'bg-emerald-600'
                  }`}></div>
                  <span className={`text-xs font-medium uppercase tracking-wide font-mono ${
                    coin.status === 'analyzing' ? 'text-amber-600' : 'text-emerald-600'
                  }`}>
        ...
        {selectedCoin && (
          <div className="border-t border-gray-700 bg-gray-900 px-6 py-2">
            <div className="text-xs text-gray-400 uppercase tracking-wide font-mono">
