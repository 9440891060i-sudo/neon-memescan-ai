...
import { Beaker, Brain, Bell, Mail } from "lucide-react";
            ...
            <main className="flex-1">
              <header className="sticky top-0 z-50 flex h-14 items-center gap-4 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 border-b border-gray-900">
                ...
                <div className="flex items-center gap-3">
                  <Bell className="w-5 h-5 text-gray-600 hover:text-gray-400 cursor-pointer transition-colors" />
                  <Mail className="w-5 h-5 text-gray-600 hover:text-gray-400 cursor-pointer transition-colors" />
